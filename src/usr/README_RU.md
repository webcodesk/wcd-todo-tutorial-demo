...
Поэтому найдите группу свойств `Main Area Padding` в копии `mainPageFrame`. Раскройте ее и измените значения свойства `Padding Top` на значение `70px`.

(имаж) 

Выберите копию `mainPageContainer` в структуре страницы и измените свойство `Max Width` на `xs`.
