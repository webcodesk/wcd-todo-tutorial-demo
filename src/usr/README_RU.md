...
> перезагрузите всю страницу в браузере и выберите "Reset to default demo" опцию после перезагрузки. 
...
> Если в центре страницы вы не видите иконки "круг с плюсом", 
> то найдите кнопку `Reload` в верхней панели и нажмите ее чтобы перезагрузить страницу.
...
> Давайте такое имя flow, которое будет ясно говорить о том, что в нем происходит.
